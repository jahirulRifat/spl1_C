...
void gameFinishedFunction(char *str2){
    ...
    if(checkFor2048()) outtextxy(70,150,"You Win The game !!!");
    else outtextxy(70,150,"You Lost The game !!!");
    sprintf(str,"Score: %d",score);
    outtextxy(95,240,str);

	setbkcolor(7);
    outtextxy(70,330,"Press Space to start!!!");

    gameFinishBoard(str2);
}
void  printButtons(FILE *fp,char *str,char *str2){
...
void firstWindow(){
    ...
    outtextxy(70,150,"Welcome to 2048 Game");
